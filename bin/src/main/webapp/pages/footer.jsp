                        ...
                        <div class="row gx-5">
                            ...
                            <div class="col-lg-4 col-md-12 pt-0 pt-lg-5 mb-5">
                                ...
                                <div class="d-flex flex-column justify-content-start">
                                    ...
                                    <a class="text-white mb-2" href="aboutl"><i
                                            class="bi bi-arrow-right text-white me-2"></i>About Us</a>
                                    <a class="text-white mb-2" href="service"><i
                                            class="bi bi-arrow-right text-white me-2"></i>Our Services</a>
                                    <a class="text-white mb-2" href="product"><i
        ...
        <div class="container-fluid bg-dark text-white py-4">
            <div class="container text-center">
                <p class="mb-0">&copy; <a class="text-secondary fw-bold" href="#">HomeSteader.Com</a>. All Rights
                    Reserved. Designed And Developed by <a class="text-secondary fw-bold"
                        href="https://www.linkedin.com/">Aniket Malve</a></p>
            </div>
        </div>
        <!-- Footer End -->
