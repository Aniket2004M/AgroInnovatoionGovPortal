            ...
            <nav class="navbar navbar-expand-lg bg-primary navbar-dark shadow-sm py-3 py-lg-0 px-3 px-lg-5">
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    <div class="navbar-nav mx-auto py-0">
                        ...
                        <a href="login" class="nav-item nav-link active"><i
                    ...
                    <div class="row g-0">
                        <div class="col-lg-7">
                            <div class="bg-primary h-100 p-5">
                                ...
                                <body>
                                    <form id="loginForm" onsubmit="return validateForm()" action="loginfarm"
                                        method="post">
                                        <div class="row g-3">
                                            <div class="col-12">
                ...
                <div class="container">
                    <div class="row gx-5">
                        ...
                        <div class="col-lg-4 col-md-6 mt-lg-n5">
                            <div class="d-flex flex-column align-items-center justify-content-center text-center h-95 bg-secondary p-5"
