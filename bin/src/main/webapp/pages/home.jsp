    ...
    <%@ taglib uri="http://www.springframework.org/tags/form" prefix="form" %>
        <%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c" %>
            ...
            <head>
                ...
                <title>HomeSteder Homepage</title>
            ...
            <body>
                            ...
                            <div class="carousel-item active">
                                ...
                                <div
                                    ...
                                    <div class="text-start p-5" style="max-width: 900px;">
                                        ...
                                        <h1 class="display-1 text-white mb-md-4">Organic Vegetables For Healthy Life
                                        </h1>
                                        <a href="farmproduct" class="btn btn-primary py-md-3 px-md-5 me-3">Our Products
                                            <i class="fa-solid fa-cart-shopping"></i></a>
                                        <a href="farmagroagency" class="btn btn-secondary py-md-3 px-md-5">Agro Agencies
                                            <i class="fa-solid fa-building-wheat"></i></a>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="bg-primary bg-vegetable d-flex flex-column justify-content-center p-5"
                                    ...
                                    <p class="text-white">Organic farming is a sustainable agricultural approach that
                                        emphasizes soil health, biodiversity, and avoiding synthetic chemicals. It
                                        promotes natural processes, such as crop rotation and composting, to enhance the
                                        ecological balance of farming systems.</p>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="bg-secondary bg-fruitfarm d-flex flex-column justify-content-center p-5"
                                    ...
                                    <p class="text-white">"At Homesteader, we recognize the crucial role that weather
                                        conditions play in the success of farming. We understand that farmers need
                                        accurate and timely information to make informed decisions for their crops and
                                        livestock.</p>
                        ...
                        <div class="row gx-5">
                            ...
                            <div class="col-lg-6 pb-5">
                                ...
                                <p class="mb-4" style="color: black;">Welcome to Homesteader, a dedicated web-based open
                                    discussion portal committed to providing invaluable information, solutions, and
                                    support to small farmers and agricultural students. Our platform serves as a dynamic
                                    hub where individuals passionate about agriculture can come together to share
                                    knowledge, engage in discussions, and access crucial resources for successful
                                    farming practices.</p>
                                <div class="row gx-5 gy-4">
                                    <div class="col-sm-6">
                                        ...
                                        <p class="mb-0" style="color: black;">our mission is to empower farmers and
                                            agricultural students with the knowledge and resources they need for
                                            sustainable and successful farming practices. </p>
                                    </div>
                                    <div class="col-sm-6">
                                        <i class="fa fa-award display-1 text-secondary"></i>
                                        <h4>Award Winning</h4>
                                        <p class="mb-0" style="color: black;">We are thrilled to announce that
                                            Homesteader has been honored with the prestigious Agricultural Innovation
                                            Excellence Award. This recognition highlights our commitment to
                                            revolutionizing the agricultural landscape by providing cutting-edge
                                            solutions and fostering a community dedicated to sustainable farming
                                            practices. </p>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row g-5">
                            <div class="col-lg-4 col-md-6">
                                ...
                                <p class="mb-4">At Homesteader, we are dedicated to providing a comprehensive suite of
                                    services designed to empower farmers and agricultural enthusiasts with the
                                    knowledge, resources, and support they need for successful and sustainable farming
                                    practices. </p>
                            ...
                            <div class="col-lg-4 col-md-6">
                                <a href="product">
                                    <div class="service-item bg-light text-center p-5" style="border-radius: 32px;">
                                        ...
                                        <h4>Quick enquiry</h4>
                                        <p class="mb-0">These quick inquiry services are designed to offer users
                                            immediate and valuable information related to their specific needs in the
                                            areas of crops, fertilizers, vegetables, seeds, and fruits on the
                                            Homesteader platform.</p>
                                    </div>
                                </a>
                            </div>
                            <div class="col-lg-4 col-md-6">
                                <a href="/">
                                    <div class="service-item bg-light text-center p-5" style="border-radius: 32px;">
                                        ...
                                        <p class="mb-0">At Homesteader, we understand the pivotal role that weather
                                            conditions play in successful farming.,Access real-time weather information,
                            ...
                            <div class="col-lg-4 col-md-6">
                                <a href="farmtrain">
                                    <div class="service-item bg-light text-center p-5" style="border-radius: 32px;">
                                        ...
                                        <p class="mb-0">At Homesteader, we recognize the importance of continuous
                                            learning in the ever-evolving field of agriculture. Engage in interactive
                                            workshops and webinars covering a range of agricultural topics.</p>
                                    </div>
                                </a>
                            </div>
                            <div class="col-lg-4 col-md-6">
                            ...
                            <div class="col-lg-6">
                                <div class="d-block bg-white h-100 text-center p-5 pb-lg-0">
                                    <p>Reliability is non-negotiable for us. Our consistent and reliable results are
                                        ...
                                        enduring partnerships with our clients. Beyond the professional realm, our
                                        passion for what we do sets us apart. It fuels our dedication, propelling us to
                                        go the extra mile and ensuring the delivery of a project that we are not only
                                        satisfied with but genuinely proud of. Choose FarnFresh for expertise,
                                        efficiency, innovation, customer-centricity, reliability, and a passion that
                                        goes beyond the ordinary.</p>
                ...
                <div class="container-fluid py-5">
                    <div class="container">
                        ...
                        <a class="btn bg-primary py-4 px-4 mx-auto text-center mb-5" href=farmproduct
                            style="color:white;"><i class="fa-solid fa-cart-shopping"></i>View All Product</a>
                    </div>
                        ...
                        <div class="row g-5">
                            ...
                            <div class="col-lg-4 col-md-6">
                                <div class="row g-0">
                                    <div class="col-10">
                                        <div class="position-relative">
                                            <img class="img-fluid w-100" src="img/team12.png" alt=""
                                                style="height: 400px;">
                                            <div class="position-absolute start-0 bottom-0 w-100 py-3 px-4"
                                                style="background: rgba(52, 173, 84, .85);">
