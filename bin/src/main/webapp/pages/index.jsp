        ...
        <body>
                    ...
                    <div class="col-lg-6">
                        <div class="d-flex align-items-center justify-content-center">
                            <a href="index.html" class="navbar-brand ms-lg-5">
                                <h1 class="m-0 display-4 text-primary"><span
                                        class="text-secondary">Homesteader</span></h1>
                            </a>
                        </div>
                    </div>
            ...
            <nav class="navbar navbar-expand-lg bg-primary navbar-dark shadow-sm py-3 py-lg-0 px-3 px-lg-5">
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    <div class="navbar-nav mx-auto py-0">
                        ...
                        <a href="stutrain" class="nav-item nav-link" style="margin-left: 700px;"><i
                                class="fa-solid fa-graduation-cap"></i>&nbsp;Agro Student</a>
                        <a href="agro" class="nav-item nav-link"><i
                                class="fa-solid fa-building-wheat"></i>&nbsp;AgroAgency Corner</a>
            ...
            <div class="floating-container zoom-in-out-box">
                <a href="stutrain">
                    <div class="floating-button">
                        <h3 style="color: white;">Student Corner<h6 style="color: blue;">click here</h6>
                        </h3>
                    </div>
                </a>
            </div>
                    ...
                    <div class="carousel-inner">
                        <div class="carousel-item active">
                            ...
                            <div
                                ...
                                <div class="text-start p-5" style="max-width: 900px;">
                                    ...
                                    <h1 class="display-1 text-white mb-md-4"> Farmer Web-based open discussion Portal
                                    </h1>
                                    <a href="register" class="btn btn-secondary py-md-3 px-md-5">Register As
                                        Farmer&nbsp;<i class="fa-solid fa-tractor"></i></a>
                                </div>
                            </div>
                        </div>
                        <div class="carousel-item">
                            ...
                            <div
                                ...
                                <div class="text-start p-5" style="max-width: 900px;">
                                    <h3 class="text-white">Welcome</h3>
                                    <h1 class="display-1 text-white mb-md-4">Be the Part of Homesteader.</h1>
                    ...
                    <div class="row gx-0">
                        <div class="col-md-6">
                            <div class="bg-primary bg-vegetable d-flex flex-column justify-content-center p-5"
                                ...
                                <p class="text-white">Organic farming is a sustainable agricultural approach that
                                    emphasizes soil health, biodiversity, and avoiding synthetic chemicals. It promotes
                                    natural processes, such as crop rotation and composting, to enhance the ecological
                                    balance of farming systems.</p>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="bg-secondary bg-fruitfarm d-flex flex-column justify-content-center p-5"
                                style="height: 300px;">
                                <h3 class="text-white mb-3">Weather Conditions</h3>
                                <p class="text-white">"At Homesteader, we recognize the crucial role that weather
                                    conditions play in the success of farming. We understand that farmers need accurate
                                    and timely information to make informed decisions for their crops and livestock.</p>
                ...
                <div class="container">
                    <div class="row gx-5">
                        ...
                        <div class="col-lg-6 pb-5">
                            ...
                            <p class="mb-4" style="color: black;">Welcome to Homesteader, a dedicated web-based open
                                discussion portal committed to providing invaluable information, solutions, and support
                                to small farmers and agricultural students. Our platform serves as a dynamic hub where
                                individuals passionate about agriculture can come together to share knowledge, engage in
                                discussions, and access crucial resources for successful farming practices.</p>
                            <div class="row gx-5 gy-4">
                                <div class="col-sm-6">
                                    <i class="fa fa-seedling display-1 text-secondary"></i>
                                    <h4>Our Mission</h4>
                                    <p class="mb-0" style="color: black;">our mission is to empower farmers and
                                        agricultural students with the knowledge and resources they need for sustainable
                                        and successful farming practices. </p>
                                </div>
                                <div class="col-sm-6">
                                    <i class="fa fa-award display-1 text-secondary"></i>
                                    <h4>Award Winning</h4>
                                    <p class="mb-0" style="color: black;">We are thrilled to announce that Homesteader
                                        has been honored with the prestigious Agricultural Innovation Excellence Award.
                                        This recognition highlights our commitment to revolutionizing the agricultural
                                        landscape by providing cutting-edge solutions and fostering a community
                                        dedicated to sustainable farming practices. </p>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="container">
                    <div class="row g-5">
                        <div class="col-lg-4 col-md-6">
                            ...
                            <p class="mb-4">At Homesteader, we are dedicated to providing a comprehensive suite of
                                services designed to empower farmers and agricultural enthusiasts with the knowledge,
                                resources, and support they need for successful and sustainable farming practices. </p>
                        ...
                        <div class="col-lg-4 col-md-6">
                            ...
                            <div class="service-item bg-light text-center p-5" style="border-radius: 32px;">
                                ...
                                <h4>Soil Analysis</h4>
                                <p class="mb-0">Homesteader's Soil Analysis Service is your first step towards
                                    cultivating a thriving and sustainable agricultural venture.</p>
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-6">
                            ...
                            <div class="service-item bg-light text-center p-5" style="border-radius: 32px;">
                                ...
                                <h4>Quick enquiry</h4>
                                <p class="mb-0">These quick inquiry services are designed to offer users immediate and
                                    valuable information related to their specific needs in the areas of crops,
                                    fertilizers, vegetables, seeds, and fruits on the Homesteader platform.</p>
                            </div>
                        ...
                        <div class="col-lg-4 col-md-6">
                            ...
                            <div class="service-item bg-light text-center p-5" style="border-radius: 32px;">
                                ...
                                <p class="mb-0">At Homesteader, we understand the pivotal role that weather conditions
                                    play in successful farming.,Access real-time weather information, including
                                    temperature, humidity and more.</p>
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-6">
                            ...
                            <div class="service-item bg-light text-center p-5" style="border-radius: 32px;">
                                ...
                                <p class="mb-0">At Homesteader, we recognize the importance of continuous learning in
                                    the ever-evolving field of agriculture. Engage in interactive workshops and webinars
                        ...
                        <div class="col-lg-4 col-md-6">
                            <a href="stutrain">
                                <div class="service-item bg-light text-center p-5" style="border-radius: 32px;">
                                    ...
                                    <p class="mb-0"> At Homesteader Agro Student Training provides a distinctive
                                        platform for you to share your agricultural knowledge, offer specialized
                                        courses, and connect directly with aspiring agri-entrepreneurs and students.
                                    </p>
                                </div>
                            </a>
                        </div>
                    ...
                    <div class="row g-5">
                        <div class="col-lg-3">
                            ...
                            <div class="text-white">
                                ...
                                <p class="mb-0">Homesteader has been honored with the prestigious Agricultural
                                    Innovation Excellence Award.</p>
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <div class="d-block bg-white h-100 text-center p-5 pb-lg-0">
                                <p>Reliability is non-negotiable for us. Our consistent and reliable results are
                                    underpinned by a commitment to integrity and transparency, fostering trust and
                                    enduring partnerships with our clients. Beyond the professional realm, our passion
                                    for what we do sets us apart. It fuels our dedication, propelling us to go the extra
                                    mile and ensuring the delivery of a project that we are not only satisfied with but
                                    genuinely proud of. Choose FarnFresh for expertise, efficiency, innovation,
                                    customer-centricity, reliability, and a passion that goes beyond the ordinary.</p>
            ...
            <div class="container-fluid py-5">
                <div class="container">
                        ...
                        <c:forEach items="${k}" var="e">
                            <div class="pb-5">
                                <div class="product-item position-relative bg-white d-flex flex-column text-center">
                                    ...
                                    <img src="product/${e.pfilen}" class="img-fluid mb-4" alt="${e.pname}"
                                        style="height: 220px; width:300px;">
                                    <h6 class="mb-3">${e.pname}</h6>Category
                                    <h6 class="mb-3">${e.ptype}</h6>
                                    <h6 class="text-danger mb-0"><i class="fas fa-tag"></i>Market Price &#x20B9; &nbsp;
                                        <del>${e.pcprice}</del></h6>
                                    <h5 class="text-primary mb-0"><i class="fas fa-tag"></i> Our Price &#x20B9;&nbsp;
                                        ${e.pwprice}</h5>
                                    <div class="btn-action d-flex justify-content-center">
                                        ...
                                        <form action="productsearch" method="post">
                                            ...
                                            <button type="button" class="btn bg-primary py-2 px-3" style="color:#fff;">
                                                Enquiry<i class="fa-solid fa-cart-shopping"></i></button>
                                        </form>
                    ...
                    <a class="btn bg-primary py-4 px-4 mx-auto text-center mb-5" href=register style="color:white;"><i
                            ...
                            <div class="row g-0">
                                <div class="col-10">
                                    <div class="position-relative">
                                        <img class="img-fluid w-100" src="img/team14.jpeg" alt=""
                                            style="height: 400px; ">
                            ...
                            <div class="row g-0">
                                <div class="col-10">
                                    <div class="position-relative">
                                        ...
                                        <div class="position-absolute start-0 bottom-0 w-100 py-3 px-4"
                                            style="background: rgba(52, 173, 84, .85);">
                                            <h4 class="text-white">Aniket Malve </h4>
                            ...
                            <div class="row gx-5">
                                <div class="col-lg-4 col-md-12 pt-5 mb-5">
                                    ...
                                    <div class="d-flex mb-2">
                                        ...
                                        <p class="text-white mb-0">Congress Bhavan, B-1, 2nd Floor, Abhinav Apartment
                                            Besides, Congress House Rd, Shivajinagar, Pune, Maharashtra 411005</p>
                                    </div>
                                    <div class="d-flex mb-2">
            ...
            <div class="container-fluid bg-dark text-white py-4">
                <div class="container text-center">
                    <p class="mb-0">&copy; <a class="text-secondary fw-bold" href="#">HomeSteader.Com</a>. All
                        Rights Reserved. Designed And Developed by <a class="text-secondary fw-bold" href=>Aniket
                            Malve</a></p>
                </div>
            </div>
            <!-- Footer End -->
