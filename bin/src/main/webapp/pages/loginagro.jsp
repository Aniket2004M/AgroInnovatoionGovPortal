        ...
        <nav class="navbar navbar-expand-lg bg-primary navbar-dark shadow-sm py-3 py-lg-0 px-3 px-lg-5">
            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
                <div class="navbar-nav mx-auto py-0">
                    ...
                    <a href="loginagro" class="nav-item nav-link active"><i
            ...
            <div class="main-agileinfo">
                <div class="agileits-top">
                    <form action="agrologin" method="post">
                        ...
                        <input class="text email" type="email" name="email" placeholder="Enter register email"
                            required="">
                    ...
                    <a href="registeragro">
                        <p style="color: #2dc653; font-family: sans-serif;">Don't have an Account? Register Now!</p>
                    </a>
