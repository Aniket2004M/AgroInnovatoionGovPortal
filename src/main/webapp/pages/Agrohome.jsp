...
<!-- Markee start -->
    <div class="marquee-container">
        <marquee class="marquee">
            Homesteader AgroAgency Registration Portal - Register your AgroAgency With Us,Submit Your Details Now , 100% Online Process. | For Any Query Contact our HelplineNumber.
        </marquee>
    </div>
