        ...
        <%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c" %>
            ...
            <body>
                ...
                <%HttpSession h1=request.getSession(false);%>
                            ...
                            <div class="col-md-5 border-right"
                                ...
                                <div class="p-3 py-5">
                                    <div class="d-flex justify-content-between align-items-center mb-3">
                                        <h4 class="text-right">User Profile Dashboard &nbsp;<i
                                                class="fa-brands fa-ubuntu" style="font-size:30px;"></i></h4>
                                    </div>
                                        ...
                                        <form action="setprofile" method="POST">
                                            <div class="row mt-3">
                                                ...
                                                <div class="col-md-12"><label class="labels"
                                                        style="font-size:15px;">Name:</label><input type="text"
                                                        class="form-control" placeholder="first name" name="name"
                                                        value="${e.name}" style="color:black;"></div>
                                            ...
                                            <div class="row mt-3">
                                                <div class="col-md-12"><label class="labels"
                                                        style="font-size:15px;">Mobile Number:</label><input type="text"
                                                        class="form-control" name="mobile"
                                                        placeholder="enter phone number" value="${e.mobile}"
                                                        style="color:black;"></div>
                                                <div class="col-md-12"><label class="labels"
                                                        style="font-size:15px;">Email Address:</label><input type="text"
                                                        class="form-control" placeholder="enter Email" name="email"
                                                        value="${e.email}" style="color:black;"></div>
                                                <div class="col-md-12"><label class="labels"
                                                        style="font-size:15px;">State:</label><input type="text"
                                                        class="form-control" placeholder="State" name="state"
                                                        value="${e.state}" style="color:black;"></div>
                                                <div class="col-md-12"><label class="labels"
                                                        style="font-size:15px;">District:</label><input type="text"
                                                        class="form-control" placeholder="District" name="city"
                                                        value="${e.city}" style="color:black;"></div>
                                                <div class="col-md-12"><label class="labels"
                                                        style="font-size:15px;">Town:</label><input type="text"
                                                        class="form-control" placeholder="Town" name="town"
                                                        value="${e.town}" style="color:black;"></div>
                                                <div class="col-md-12"><label class="labels"
                                                        style="font-size:15px;">Village:</label><input type="text"
                                                        class="form-control" placeholder="enter address l"
                                                        name="village" value="${e.village}" style="color:black;"></div>

                                                <input type="hidden" value="${e.password}" name="password">
                                                <input type="hidden" value="${e.id}" name="id">

                                                <div class="col-md-12"><label class="labels"
                                                        style="font-size:15px;">Soil Type:</label>
                                                    <select name="soiltype" class="form-control" id="dropdown"
                                                        ...
                                                        <option value="Mountainous or Forest Soil">Mountainous or Forest
                                                            Soil</option>
                                                        <option value="Arid or Desert Soil">Arid or Desert Soil</option>
                                                        <option value="Saline and Alkaline Soil">Saline and Alkaline
                                                            Soil</option>
                                                        <option value="Peaty and Marshy Soil">Peaty and Marshy Soil
                                                        </option>
                                                    </select>
                                                </div>
                    ...
                    <h4 style="text-align:center;">My Activities &nbsp;<i class="fa-solid fa-users-gear"
                                ...
                                <tr>
                                    ...
                                    <td data-label="Download PDF">
                                        ...
                                        <form action="getpdf" method="post">
                                            ...
                                            <input type="text" value="<%out.println(s1.getAttribute(" email"));%>"
                                            name="email" style="display:none;">


                                            <button type="submit" style="color:#1a8cff;">Download PDF &nbsp;<i
