            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
                <div class="navbar-nav w-100 d-flex align-items-center py-0 justify-content-between">
                    <div class="d-flex align-items-center">
                        ...
                        <a href="login" class="nav-item nav-link fw-bold active"><i class="fa-solid fa-seedling text-primary me-1"></i>Login</a>
                    </div>
                    <div class="d-flex align-items-center">
    ...
    <div class="row g-3">
        ...
        <div class="col-12">
            <div class="input-group">
                ...
                <button class="btn btn-outline-secondary bg-light border-0" type="button" id="togglePassword" style="height: 55px; border-radius: 0 0.25rem 0.25rem 0;">
