...
public class FarmController {
	...
	m.addAttribute("error", "Email is already registered! Please use a different email or login.");
	  return "register";
	...
	public String logincheck(@RequestParam("email") String email,@RequestParam("password") String password,HttpSession h1, ModelMap mm) {
