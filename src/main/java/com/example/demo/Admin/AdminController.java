...
public class AdminController {
	...
	public String admindash(ModelMap mm, HttpSession h1) {
		...
		if (x == null) {
			...
			// Safely get total farmer metrics instead of replying on the insecure HttpSession increment approach
			int totalFarmers = fs.showallfarmer().size();
			mm.addAttribute("totalFarmers", totalFarmers);
	...
	public String addnewproduct(@ModelAttribute("c2") product c2, @RequestParam("pfile") MultipartFile filename1)
		...
		String path1 = "C:\\Users\\anike\\Documents\\mca\\MCA 4 Java Project\\HOMESTEADERINDIA-Spring-Boot-Java-Project-master\\HOMESTEADERINDIA-Spring-Boot-Java-Project-master\\src\\main\\resources\\static\\product";

		// String
		// path1="C:\\Users\\gaura\\eclipse-workspace\\CravitaProject_HomeSteader\\src\\main\\resources\\static\\product";
	...
	@RequestMapping("/blog")
	public String Blogupload(ModelMap mm, HttpSession h1) {
		String check = (String) h1.getAttribute("username");
		if (check == null) {
			return "loginadmin";
		}
	...
	public String uploadblog(@ModelAttribute("c4") blog c4, @RequestParam("blogfile") MultipartFile filename) {
		...
		try {
			...
			if (f1 != null && !f1.isEmpty()) {
				// String
				// path1="C:\\Users\\gaura\\eclipse-workspace\\CravitaProject_HomeSteader\\src\\main\\resources\\static\\blogimg";
				String path1 = "C:\\Users\\anike\\Documents\\mca\\MCA 4 Java Project\\HOMESTEADERINDIA-Spring-Boot-Java-Project-master\\HOMESTEADERINDIA-Spring-Boot-Java-Project-master\\src\\main\\resources\\static\\blogimg";
				BufferedOutputStream b1 = new BufferedOutputStream(new FileOutputStream(path1 + "/" + f1));
				...
				c4.setBlogimg(""); // Proceed without image if not provided
			}
			...
			e.printStackTrace();
			// Optionally return an error page or message here
		} catch (Exception e) {
			e.printStackTrace();
		}
