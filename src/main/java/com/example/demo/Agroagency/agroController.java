...
//	@RequestMapping("/agro")
	...
	@PostMapping("/agro")
	public String agroagencyRegisterprocess(@ModelAttribute("c1") agroEntity c1, @RequestParam("email") String email,
			@RequestParam("file") MultipartFile filename) throws IOException {

		if (filename == null || filename.isEmpty()) {
// handle missing file (return to register or set default)
			return "registeragro";
		}
		...
		// String path =
		// ("C:\\Users\\gaura\\eclipse-workspace\\CravitaProject_HomeSteader\\src\\main\\resources\\static\\certificate");

		java.io.File out = new java.io.File(path, f);
		out.getParentFile().mkdirs(); // ensure dir exists

		try (BufferedOutputStream b = new BufferedOutputStream(new java.io.FileOutputStream(out))) {
